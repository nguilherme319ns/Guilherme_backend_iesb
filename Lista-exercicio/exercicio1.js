...
const nota1 = Number(prompt("Digite a primeira nota 1: ").replace(',','.'))
const nota2 = Number(prompt("Digite a segunda nota 2: ").replace(',', '.'))
const nota3 = Number(prompt("Digite a terceira nota 3: ").replace(',', '.'))
const nota4 = Number(prompt("Digite a quarta nota 4: ").replace(',', '.'))
